   ...
   const [errors, setErrors] = useState({
    ...
    const handleSearchButton=()=>{
     ...
     const handleUpdateButton=()=>{
        ...
        axios.put( `${API_URL}/student/edit`,obj).then((res)=>{
            alert(res.data);
        }).catch((err)=>{
            alert(err);
        });   
    ...
    return(
        <div className="container">
            <center>
                <h4 className="heading">Search Student By Roll No and Update Details</h4>
                ...
                <table>
                    ...
                    <td>Name</td>
                    <td>
                        <input type="text" onChange={handleSName} value={sname}/>
                ...
                <tr>
                    <td>Marks</td>
                    <td>
                        <input type="number" onChange={handleMarks} value={marks}/>
